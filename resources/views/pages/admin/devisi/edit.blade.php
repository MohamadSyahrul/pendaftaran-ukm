        ...
        <div class="row clearfix justify-content-center">
            <div class="col-12 col-md-6 col-lg-10">
                <div class="card">
                    ...
                    <form class="form form-horizontal" action="{{route('devisi.update',$item->id)}}"
                       ...
                       <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="nama_devisi" value="{{$item->nama_devisi}}">
                        </div>
                    </div>
                    </div>
                        <div class="card-footer text-right">
                            <!-- <button type="reset" class="btn btn-light mr-3"><a href="{{route('list-ukm.index')}}"> Cancel </a></button> -->
